...
var AframeContext = /*#__PURE__*/function () {
  function AframeContext(settings) {
    ...
    this.assetManager = new _assetManager__WEBPACK_IMPORTED_MODULE_0__["default"](this.scene, settings.id);
  }
 ...
 * @Date: 2023-11-16 17:03:49
 * @LastEditors: Wandayu 903298500@qq.com
 * @LastEditTime: 2023-11-20 14:54:04
 * @FilePath: \web2vr\src\assetManager.js
 * @Description:
 *
 * Copyright (c) 2023 by ${git_name_email}, All Rights Reserved.
 */
var AssetManager = /*#__PURE__*/function () {
  function AssetManager(scene, id) {
    _classCallCheck(this, AssetManager);

    // <a-assets class="this.id" id="asset-this.id-currentAssetId">
    this.id = id;
    var assets = document.querySelector("a-assets#".concat(this.id));
    if (assets) this.assets = assets;else {
      this.assets = document.createElement("a-assets");
      this.assets.setAttribute("id", this.id);
  ...
  _createClass(AssetManager, [{
    ...
    value: function updateCurrentAssetIdReturn() {
      ...
      return "asset-" + this.id + "-" + this.assets.getAttribute("current-id");
    ...
    value: function createAsset(path, type) {
      ...
      this.updateCurrentAssetId();
      var id = "asset-" + this.id + "-" + this.assets.getAttribute("current-id");
...
var ContainerElement = /*#__PURE__*/function (_Element) {
  ...
  function ContainerElement(web2vr, domElement, layer) {
    ...
    if (!_this.textOnly) {
      ...
      if (_this.domElement == _this.web2vr.container) {
        _this.entity.setAttribute("material", "side", "double");
 ...
 * @Date: 2023-11-16 17:03:49
 * @LastEditors: Wandayu 903298500@qq.com
 * @LastEditTime: 2023-11-20 15:16:20
 * @FilePath: \web2vr\src\elements\svgElement.js
 * @Description:
 *
 * Copyright (c) 2023 by ${git_name_email}, All Rights Reserved.
 */
...
/* harmony import */ var nanoid__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! nanoid */ "./node_modules/nanoid/index.browser.js");
function _createForOfIteratorHelper(o, allowArrayLike) { var it; if (typeof Symbol === "undefined" || o[Symbol.iterator] == null) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = o[Symbol.iterator](); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }
 ...
 * @Date: 2023-11-16 17:03:49
 * @LastEditors: Wandayu 903298500@qq.com
 * @LastEditTime: 2023-11-20 14:54:26
 * @FilePath: \web2vr\src\web2vr.js
 * @Description:
 *
 * Copyright (c) 2023 by ${git_name_email}, All Rights Reserved.
 */
...
var Web2VR = /*#__PURE__*/function () {
  function Web2VR(container) {
    ...
    }); // give the id value with nanoid if not set

    this.settings.id = this.settings.id || Object(nanoid__WEBPACK_IMPORTED_MODULE_22__["nanoid"])(10); // aframe context
